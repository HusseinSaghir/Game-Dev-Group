class_name Pistol
extends EquipItem
#This is the pistol weapon
#It will shoot a faster but thinner projectile that pierces through all enemies deeling lower damage
...
const BULLET = preload("res://scenes/weapons/Projectile/pistol_projectile.tscn")
