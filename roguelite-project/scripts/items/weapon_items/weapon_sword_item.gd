extends EquipItem
#This is the sword weapon item so the player can equip the sword
@export var type_weapon : PackedScene

#When the player touches this weapon it will unequip the old weapon and equidp the new one
