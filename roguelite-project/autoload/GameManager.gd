...
const SPLASH_SCENE = "res://scenes/rooms/splash_screen.tscn"
const MAIN_MENU_SCENE = "res://scenes/rooms/main_menu.tscn"
const GAME_SCENE = "res://scenes/rooms/game_world.tscn"
